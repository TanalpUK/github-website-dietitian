...
const ContactInfo = () => {
  ...
  return (
    <section id="contact-info" className="py-12 bg-background">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {contactDetails.map((detail, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  className="group hover:shadow-hover transition-all duration-300 border-2 hover:border-primary/20"
                >
          ...
          <div className="bg-card rounded-2xl shadow-card overflow-hidden mb-12">
            <div className="aspect-video bg-secondary/50 flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <h3 className="text-xl font-semibold mb-2">Konum Haritası</h3>
                <p className="text-muted-foreground">
                  Kliniğimizin konumunu görmek için harita entegrasyonu eklenebilir
                </p>
                <a 
              ...
              {socialLinks.map((social, index) => {
                ...
                return (
                  <a
                    ...
                    className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-secondary text-foreground hover:bg-primary hover:text-primary-foreground transition-all shadow-sm hover:shadow-md"
                  >
